...
namespace EduHome.Migrations
{
    ...
    [Migration("20210615144155_AddCategoryCategoryCourseCategoryEventAndCategoryBlogTables")]
    partial class AddCategoryCategoryCourseCategoryEventAndCategoryBlogTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduHome.Models.CategoryBlog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EduHome.Models.CategoryCourse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EduHome.Models.TeacherProfession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EduHome.Models.Skill", b =>
                {
                    b.HasOne("EduHome.Models.TeacherDetail", "TeacherDetail")
                        .WithOne("Skill")
                        .HasForeignKey("EduHome.Models.Skill", "TeacherDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EduHome.Models.TeacherContactInfo", b =>
                {
                    b.HasOne("EduHome.Models.TeacherDetail", "TeacherDetail")
                        ...
                        .HasForeignKey("EduHome.Models.TeacherContactInfo", "TeacherDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
